...
<head>
    ...
    <!--Favicon-->
    <link rel="shortcut icon" href="{{asset('assets/images/favicon/Icon2.jpg')}}">
    ...
    <script src="{{asset('assets/js/fontawesome_js/all.min.js')}}"></script>
    <!--Owl-Carousel-->
    ...
    <!--Responsive tabs-->
    <link rel="stylesheet" href="{{asset('assets/css/responsive-tabs/responsive-tabs.css')}}">
    <!--Magnific Popup-->
    ...
    <header>
        <nav class="navbar navbar-expand-md fixed-top white-nav-top">
            ...
            <a class="navbar-brand smooth-scroll" href="#home">
                <img src="{{asset('assets/images/favicon/Icon2.jpg')}}" alt='Logo'>
            </a>
            <!--
...
-->
    ...
    <section id="home">
        <!--Background video-->
        <video id='home-bg-video' poster="{{asset('assets/images/home-poster/poster.jpg')}}" autoplay muted loop>
            <source src="{{asset('assets/videos/home-video.mp4')}}" type='video/mp4'>
            <source src="{{asset('assets/videos/home-video.ogv')}}" type='video/ogv'>
            <source src="{{asset('assets/videos/home-video.webm')}}" type='video/webm'>
        </video>
        <!--Overlay-->
        <div id="home-overlay">
            ...
            <div class="content-box-lg">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div id="about-bottom">
                                <img src="{{asset('assets/images/about/about-us.png')}}" class='img-fluid' alt='About Us'>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div id="team-right" class="owl-carousel owl-theme">
                                ...
                                <div class="team-member">
                                    <img src="{{asset('assets/images/team/member1.jpg')}}" alt="Team Member" class='img-fluid'>
                                ...
                                <!--Member 02-->
                                <div class="team-member">
                                    <img src="{{asset('assets/images/team/member2.jpg')}}" alt="Team Member" class='img-fluid'>
                                    <div class="team-member-overlay">
                                        <div class="team-member-info text-center">
                                            <h6>Azeem Prem</h6>
                                            <p>Java Developer</p>
                                ...
                                <!--Member 03-->
                                <div class="team-member">
                                    <img src="{{asset('assets/images/team/member3.jpg')}}" alt="Team Member" class='img-fluid'>
                                    <div class="team-member-overlay">
                                        <div class="team-member-info text-center">
                                            <h6>Prem Rathan</h6>
                                            <p>Team Developer</p>
                                ...
                                <!--Member 04-->
                                <div class="team-member">
                                    <img src="{{asset('assets/images/team/member4.jpg')}}" alt="Team Member" class='img-fluid'>
                                    <div class="team-member-overlay">
                                        <div class="team-member-info text-center">
                                            <h6>George</h6>
                                            <p>JS Developer</p>
                                ...
                                <!--Member 05-->
                                <div class="team-member">
                                    <img src="{{asset('assets/images/team/member5.jpg')}}" alt="Team Member" class='img-fluid'>
                                    <div class="team-member-overlay">
                                        <div class="team-member-info text-center">
                                            <h6>Kranthi Kiran</h6>
                                ...
                                <!--Member 06-->
                                <div class="team-member">
                                    <img src="{{asset('assets/images/team/member6.jpg')}}" alt="Team Member" class='img-fluid'>
                                    <div class="team-member-overlay">
                                        <div class="team-member-info text-center">
                                            <h6>Tata</h6>
                                            <p>Web Developer</p>
        ...
        <div id="services-01">
            <div class="content-box-lg">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <img src="{{asset('assets/images/services/services-01.jpg')}}" alt="Services" class='img-fluid'>
                        </div>
                        <div class="col-md-5">
                            <!--Services01-->
                            <div class="service">
                ...
                <div id="service-tabs">
                    ...
                    <div id="services-tab-1" class="services-tab">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/images/services/service-tab-image-01.jpg')}}" alt="Services" class='img-fluid'>
                                </div>
                                <div class="col-md-6">
                                    <div class="tab-bg">
                                        <h2>01</h2>
                    ...
                    <div id="services-tab-2" class="services-tab">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/images/services/service-tab-image-02.jpg')}}" alt="Services" class='img-fluid'>
                                </div>
                                <div class="col-md-6">
                                    <div class="tab-bg">
                                        <h2>02</h2>
                    ...
                    <div id="services-tab-3" class="services-tab">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/images/services/service-tab-image-03.jpg')}}" alt="Services" class='img-fluid'>
                                </div>
                                <div class="col-md-6">
                                    <div class="tab-bg">
                                        <h2>03</h2>
                    ...
                    <div id="services-tab-4" class="services-tab">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/images/services/service-tab-image-04.jpg')}}" alt="Services" class='img-fluid'>
                                </div>
                                <div class="col-md-6">
                                    <div class="tab-bg">
                                        <h2>04</h2>
        ...
        <div class="container-fluid">
            <div class="row grid">
                ...
                <div class="col-md-3 portfolio-item logo web">
                    <a href="{{asset('assets/images/work/work-01.jpg')}}">
                        <img src="{{asset('assets/images/work/work-01.jpg')}}" alt='Portfolio-Item' class='img-fluid'>
                ...
                <div class="col-md-3 portfolio-item mobile desktop">
                    <a href="{{asset('assets/images/work/work-02.jpg')}}">
                        <img src="{{asset('assets/images/work/work-02.jpg')}}" alt='Portfolio-Item' class='img-fluid'>
                        <div class="portfolio-item-overlay">
                            <div class="portfolio-item-details">
                                <!--Item Header-->
                                <h3>Web Design</h3>
                ...
                <div class="col-md-3 portfolio-item logo desktop">
                    <a href="{{asset('assets/images/work/work-03.jpg')}}">
                        <img src="{{asset('assets/images/work/work-03.jpg')}}" alt='Portfolio-Item' class='img-fluid'>
                        <div class="portfolio-item-overlay">
                            <div class="portfolio-item-details">
                                <!--Item Header-->
                ...
                <div class="col-md-3 portfolio-item mobile web">
                    <a href="{{asset('assets/images/work/work-04.jpg')}}">
                        <img src="{{asset('assets/images/work/work-04.jpg')}}" alt='Portfolio-Item' class='img-fluid'>
                        <div class="portfolio-item-overlay">
                            <div class="portfolio-item-details">
                                <!--Item Header-->
                ...
                <div class="col-md-3 portfolio-item web desktop mobile">
                    <a href="{{asset('assets/images/work/work-05.jpg')}}">
                        <img src="{{asset('assets/images/work/work-05.jpg')}}" alt='Portfolio-Item' class='img-fluid'>
                        <div class="portfolio-item-overlay">
                            <div class="portfolio-item-details">
                                <!--Item Header-->
                                <h3>Web Development</h3>
                ...
                <div class="col-md-3 portfolio-item desktop">
                    <a href="{{asset('assets/images/work/work-06.jpg')}}">
                        <img src="{{asset('assets/images/work/work-06.jpg')}}" alt='Portfolio-Item' class='img-fluid'>
                        <div class="portfolio-item-overlay">
                            <div class="portfolio-item-details">
                                <!--Item Header-->
                                <h3>Digital Marketing</h3>
                ...
                <div class="col-md-3 portfolio-item web">
                    <a href="{{asset('assets/images/work/work-07.jpg')}}">
                        <img src="{{asset('assets/images/work/work-07.jpg')}}" alt='Portfolio-Item' class='img-fluid'>
                        <div class="portfolio-item-overlay">
                            <div class="portfolio-item-details">
                                <!--Item Header-->
                                <h3>Web Design</h3>
                ...
                <!--Portfolio Items-8-->
                <div class="col-md-3 portfolio-item logo web">
                    <a href="{{asset('assets/images/work/work-08.jpg')}}">
                        <img src="{{asset('assets/images/work/work-08.jpg')}}" alt='Portfolio-Item' class='img-fluid'>
                        <div class="portfolio-item-overlay">
                            <div class="portfolio-item-details">
                                <!--Item Header-->
                                <h3>Logo Design</h3>
                    ...
                    <div id="testimonial-slider" class='owl-carousel owl-theme'>
                        ...
                        <div class="testimonial">
                            ...
                            <div class="row author">
                                <div class="col-md-2">
                                    <img src="{{asset('assets/images/testimonials/client-01.jpg')}}" alt='Customer' class='img-fluid rounded-circle'>
                                </div>
                                <div class="col-md-10">
                        ...
                        <div class="testimonial">
                            ...
                            <div class="row author">
                                <div class="col-md-2">
                                    <img src="{{asset('assets/images/testimonials/client-02.jpg')}}" alt='Customer' class='img-fluid rounded-circle'>
                                </div>
                                <div class="col-md-10">
                                    <div class="author-details">
                                        <p>Full Name</p>
                        ...
                        <div class="testimonial">
                            ...
                            <div class="row author">
                                <div class="col-md-2">
                                    <img src="{{asset('assets/images/testimonials/client-03.jpg')}}" alt='Customer' class='img-fluid rounded-circle'>
                                </div>
                                <div class="col-md-10">
                                    <div class="author-details">
                                        <p>Full Name</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="clients-list" class='owl-carousel owl-theme'>
                            <!-- Clients 01-->
                            <div class="client">
                                <img src="{{asset('assets/images/clients/client-01.jpg')}}" alt='Clients' class='img-fluid'>
                            </div>
                            <!-- Clients 02-->
                            <div class="client">
                                <img src="{{asset('assets/images/clients/client-02.jpg')}}" alt='Clients' class='img-fluid'>
                            </div>
                            <!-- Clients 03-->
                            <div class="client">
                                <img src="{{asset('assets/images/clients/client-03.jpg')}}" alt='Clients' class='img-fluid'>
                            </div>
                            <!-- Clients 04-->
                            <div class="client">
                                <img src="{{asset('assets/images/clients/client-04.jpg')}}" alt='Clients' class='img-fluid'>
                            </div>
                            <!-- Clients 05-->
                            <div class="client">
                                <img src="{{asset('assets/images/clients/client-05.jpg')}}" alt='Clients' class='img-fluid'>
                            </div>
                            <!-- Clients 06-->
                            <div class="client">
                                <img src="{{asset('assets/images/clients/client-06.jpg')}}" alt='Clients' class='img-fluid'>
                            </div>
                            <!-- Clients 07-->
                            <div class="client">
                                <img src="{{asset('assets/images/clients/client-07.jpg')}}" alt='Clients' class='img-fluid'>
                            </div>
                            <!-- Clients 08-->
                            <div class="client">
                                <img src="{{asset('assets/images/clients/client-08.jpg')}}" alt='Clients' class='img-fluid'>
                            </div>
                            <!-- Clients 09-->
                            <div class="client">
                                <img src="{{asset('assets/images/clients/client-09.jpg')}}" alt='Clients' class='img-fluid'>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="blog-post">
                                    ...
                                    <div class="post-meta">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><img src="{{asset('assets/images/blog/author-1.jpg')}}" alt='Author'> Author Name</p>
                                            </div>
                                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="blog-post">
                                    ...
                                    <div class="post-meta">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><img src="{{asset('assets/images/blog/author-2.jpg')}}" alt='Author'> Author Name</p>
                                            </div>
                                            <div class="col-md-6">
                                                <p class='text-right'>June 30,2020</p>
                                            </div>
    ...
    <!--Responsive tabs-->
    <script src='{{asset('assets/js/responsive-tabs/jquery.responsiveTabs.min.js')}}'></script>
    <!--Isotope-->
